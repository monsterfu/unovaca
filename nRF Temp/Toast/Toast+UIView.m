...
- (void)showToast:(UIView *)toast duration:(CGFloat)interval position:(id)point {
    ...
    [UIView animateWithDuration:CSToastFadeDuration
                     ...
                     animations:^{
                         toast.alpha = 1.0;
                         toast.frame = CGRectMake(12, toast.frame.origin.y + 15, 296, toast.frame.size.height);
                         ...
                         [UIView animateWithDuration:CSToastFadeDuration
                                          ...
                                          animations:^{
                                              toast.alpha = 0.0;
                                              toast.frame = CGRectMake(12, toast.frame.origin.y - 10, 296, toast.frame.size.height);
                                          } completion:^(BOOL finished) {
...
//                return CGPointMake(self.bounds.size.width / 2, self.bounds.size.height / 2);
                return CGPointMake(self.bounds.size.width / 2, 60);
            }
            else
            {
//                return CGPointMake(self.bounds.size.width / 2, self.bounds.size.height / 2.5);
                return CGPointMake(self.bounds.size.width / 2, 60);
            }
...
//        messageLabel.frame = CGRectMake(0.0, 0.0, expectedSizeMessage.width, expectedSizeMessage.height);
        messageLabel.frame = CGRectMake(12, 0.0, 296, expectedSizeMessage.height);
    }
...
//    wrapperView.frame = CGRectMake(0.0, 0.0, wrapperWidth, wrapperHeight);
    wrapperView.frame = CGRectMake(12, 0.0, 296, wrapperHeight);
